...
public class Praktikum {
    ...
    private static int makeRace(Car userCar, Car opponentCar, int distance) {
        printFlag();
        boolean shortRaceWin = distance <= 15;
        boolean longRaceWin = distance > 50;

        if ((shortRaceWin && (userCar.acceleration > opponentCar.acceleration)) || (longRaceWin && (userCar.maxSpeed > opponentCar.maxSpeed))) {
